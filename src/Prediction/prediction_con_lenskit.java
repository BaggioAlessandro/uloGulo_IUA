...
public class prediction_con_lenskit {
	...
	public static void main(String[] args) throws Exception {
		...
		String user_path = new String("src/Dati/Test/test_user_data.arff");
		String training = new String("src/Dati/Test/join-user-rating.arff");
		String sample_path = new String("src/Dati/Test/new_sample.arff");
		...
		PredittoreLenskit pred = new PredittoreLenskit(new File("src/Dati/Test/train.csv"), new String("src/Dati/Test/test.arff"));

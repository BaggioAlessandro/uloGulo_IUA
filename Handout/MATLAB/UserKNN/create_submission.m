...
%load input data
[R, testUsers] = load_data('./data/train.csv', './data/test.csv', 1);
...
%nnModel(:,2:(K+1)) prendo la matrice partendo dalla seconda colonna perche la prima e l'elemento stesso
